  ...
  return (
    <>
      {/* <Layout> */}
                          ...
                          <Form.Row>
                            <Col xs={12} md={3} className="mr-md-3">
                              <Form.Group controlId="exampleForm.ControlSelect1">
                                <Form.Label>Jenis Penetapan NIP</Form.Label>
                                <Form.Control as="select" size="sm">
                                  <option>--Pilih Jenis Penetapan NIP--</option>
                            ...
                            <Col xs={12} md={3} className="ml-md-5">
                              <Form.Group controlId="exampleForm.ControlSelect1">
                                ...
                                <Form.Control as="select" size="sm">
                                  <option>--Pilih Status Usulan--</option>
        ...
        <Link href='/layananKP/suratUsulan/step-2'>
