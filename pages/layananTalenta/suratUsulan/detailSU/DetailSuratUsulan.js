                ...
                <Form>
                    ...
                    <Form.Row>
                        ...
                        <Col xs={10} md={5} lg={5}>
                            <Form.Group controlId="exampleForm.ControlSelect1">
                                    ...
                                    <Form.Control style={{width:'96%'}} size="sm" as="select">
                    ...
                    <Form.Row>
                        <Col className="mr-2" xs={10} md={5} lg={5}>
                            ...
                            <Form.Control size="sm" type="text" placeholder="Rumah Sakit A"/>
                        </Col>
                        <Col xs={10} md={5} lg={5}>
                            <Form.Label className="ml-3">Dokumen Kesehatan</Form.Label>
                            <Form.File 
            ...
            <Card>
              ...
              <Form.Row>
                        ...
                        <Form.Row>
                            ...
                            <Form.Label className="">Dokumen Pendukung A</Form.Label>
                            <Form.File 
                                id="custom-file-translate-scss"
                                label="Custom file input"
                                lang="en"
                        ...
                        <Col className="ml-4">
                            <Form.Row>
                            <Col xs={10} md={10} lg={10}>
                            <Form.Label className="">Dokumen Pendukung B</Form.Label>
                            <Form.File 
                                id="custom-file-translate-scss"
                                label="Custom file input"
                                lang="en"
