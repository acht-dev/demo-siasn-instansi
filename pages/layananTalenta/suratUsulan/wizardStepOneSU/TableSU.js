      ...
      return (
        <tbody>
          <tr>
            ...
            <td>{getDetail.jenisKegiatan}</td>
            <td>{getDetail.tglPengusulan}</td>
            <td>{filterCSS(getDetail.statusUsulan)}</td>
            <td><a className="font-weight-normal" href="/layananTalenta/suratUsulan/detailSU/DetailSuratUsulan" style={{color:'#2D3C6C',fontSize:'120%'}}>Detail</a></td>
          </tr>
        </tbody>
         );
        })}
