          ...
          <Form>
            ...
            <Form.Row>
              <Col xs={12} md={12}>
                <Form.Group controlId="noSuratUsulan">
                  <Form.Label>Nomor Surat Usulan</Form.Label>
                  <textarea rows={10} cols={140} className="form-control" name="noSuratUsulan" autofocus>
                    - Nama saya masih salah - NIP belum di update
                  </textarea>
                </Form.Group>
              </Col>
            </Form.Row>
            ...
            <div className="wizard__inputForm-buttonBox mt-3">
              <Link href="/laynanTalenta/monitoringPenetapan/wizardDetail/DetailPenetapan ">
                <Button className="mr-4 wizard__formButtonReset" type="submit">
                  KEMBALI
                </Button>
              </Link>

              <Link href="/laynanTalenta/monitoringPenetapan ">
