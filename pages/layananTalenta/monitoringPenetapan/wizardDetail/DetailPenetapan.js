    ...
    <>
      <Layout>
        ...
        <div className="wizard__title">
          <h2>Dokumen Penetapan Kegiatan</h2>
        </div>
        {/* Card Profile */}
        <CardProfile />
        {/* End Card Profile */}
        ...
        <div className="wizard__inputForm">
          <Form>
            <div className="mb-3">
              <h3>Dokumen Penetapan Kegiatan</h3>
            </div>
            <Form.Row>
              <Col xs={12} md={6} className="mr-md-5">
                <Form.Group controlId="nip">
                  <Form.Label>Silahkan Unduh Dokumen SK/PERTEK di bawah ini</Form.Label>
                  <a href="../../file/SK_PERTEK.pdf" download>
                    <div className="input-group">
                      <Form.Control disabled type="text" className="custominput" defaultValue="SK_PERTEK.pdf" />
            ...
            <div className="wizard__inputForm-buttonBox mt-3">
              ...
              <Link href="/layananTalenta/monitoringPenetapan/routePembatalan">
                <Button className="mr-4 wizard__formButtonPembatalan" type="submit">
                  AJUKAN PEMBATALAN
                </Button>
              </Link>

              <Link href="/layananTalenta/monitoringPenetapan/routePerbaikan ">
                <Button className="wizard__formButtonSubmit" type="button" onClick={handleReset}>
                  AJUKAN PERBAIKAN
                </Button>
              </Link>
            </div>
