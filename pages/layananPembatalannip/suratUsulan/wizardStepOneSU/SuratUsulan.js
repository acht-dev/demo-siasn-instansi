  ...
  return (
    <>
      <Layout>
          ...
          <Form>
            <Form.Row>
              <Col xs={12} md={3} className='mr-md-3'>
                <Form.Group controlId='nomorPeserta'>
              ...
              <Col xs={12} md={3} className='mr-md-3 ml-md-3'>
                <Form.Group controlId='exampleForm.ControlSelect1'>
                  <Form.Label>Jenis Pembatalan</Form.Label>
                  <Form.Control
                    as='select'
                    size='sm'
                    style={{ fontSize: "17px" }}>
                    {selectOptions.jenisPembatalan.map((data) => {
        ...
        <Link href='/layananPengadaan/suratUsulan/step-2'>
