...
import ShowButton from "../wizardStepOneSK/ShowButton";

import "bootstrap/dist/css/bootstrap.min.css";

export default function DetailSuratKeputusan() {

  const selectOptions = {
    jenisPenyakit: ["--- Jenis Penyakit ---", "Aaaa", "Bbb", "Ccc"],
    kategori: ["--- Kategori ---", "Aaaa", "Bbb", "Ccc"],
    status: ["--- Status ---", "Aaaa", "Bbb", "Ccc"],
    lokasiPerawatan: ["--- Lokasi Perawatan A ---","Lokasi Perawatan B","Lokasi Perawatan C"]
  };
