            ...
            <Col md={10}>
              <Form.Row>
                <Col>
                  ...
                  <Form.Control type="text" id="inlineFormInputName" defaultValue={"197003191997031002"} required />
                </Col>
                ...
                <Col className="">
                  ...
                  <Form.Control type="text" id="inlineFormInputName" placeholder="Cari pegawai dengan NIP Lama..." />
                </Col>
                <Col xs={1} className="my-4">
