    ...
    <main className={styles.main}>
      <section className={styles.container}>
        <div className={styles.components}>
          ...
          {/* Judul 5 */}
          <Form.Row className="Step-3">
            <Col md={5}>Surat Penetapan Prestasi Kerja Luar Biasa di tandatangani PPK*</Col>
          ...
          {/* Judul 8 */}
          <Form.Row className="Step-3">
            <Col md={5}>SK Pengangkatan  Dalam Jabatan Terakhir*</Col>
            <Col md={5} className="paddingLeft">Surat Pernyataan Pelantikan Dalam Jabatan Terakhir*</Col>
          </Form.Row>
          ...
          <Form.Row className="Step-3">
           ...
           {/* Judul 10 */}
           <Form.Row className="Step-3">
            <Col md={5}>Berita Acara Sumpah/Janji/Pelatikan Jabatan atau SPMT</Col>
            <Col md={5} className="paddingLeft">
              Surat Perintah Pelaksanaan Tugas (plt) dari Pejabat Pembina Kepegawaian
            </Col>
          </Form.Row>
