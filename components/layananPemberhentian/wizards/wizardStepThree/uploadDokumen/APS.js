          ...
          <Card>
            <Card.Body>
              ...
              <Form.Row className="Step-3">
                <Col md={6}>Dok SK Pemberhentian APS*</Col>
              ...
              <Form.Row className="Step-3">
                ...
                <Col className="paddingLeft">Surat Usul Pemberhentian APS sebagai PNS dari Instansi</Col>
              </Form.Row>
              ...
              {/* Judul 3 */}
              <Form.Row className="Step-3">
                <Col md={6}>Surat Permohonan Berhenti Atas Permintaan Sendiri sebagai PNS</Col>
