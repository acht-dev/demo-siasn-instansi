            ...
            <Card>
              <Card.Body>
                ...
                <Form.Row className="Step-3">
                  <Col md={6}>Dok SK Pemberhentian Atas Meninggal Dunia (Janda/Duda)*</Col>
                ...
                <Form.Row className="Step-3">
                  ...
                  <Col className="paddingLeft">
                      Surat Pernyataan Tidak Sedang Menjalani Proses Pidana/ Pernah Dipidana</Col>
                </Form.Row>
                ...
                {/* Judul 3 */}
                <Form.Row className="Step-3">
                  <Col md={6}>Surat Pernyataan Tidak Pernah Dijatuhi HD Tingkat Sedang/ Berat</Col>
                ...
                <Form.Row className="Step-3">
                  ...
                  <Col className="paddingLeft">Surat Keterangan Duda dari Kelurahan/Kecamatan</Col>
                </Form.Row>
                ...
                {/* Judul 5 */}
                <Form.Row className="Step-3">
                  <Col md={6}>Surat Keterangan Kematian</Col>
                  <Col className="paddingLeft"> Surat Keputusan Peninjauan Masa Kerja</Col>
                </Form.Row>
