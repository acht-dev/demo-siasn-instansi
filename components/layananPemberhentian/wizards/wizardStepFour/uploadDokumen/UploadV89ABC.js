      ...
      <section className={styles.container}>
        <div className={styles.components}>
          ...
          <Form.Row className="Step-3">
            ...
            <Col className="paddingLeft">Realisasi SKP 1 Tahun Terakhir *</Col>
          </Form.Row>
          ...
          <Form.Row className="Step-3">
            ...
            <Col className="paddingLeft">Kepres Tentang Penemuan Baru *</Col>
          </Form.Row>
          ...
          {/* Judul 8 */}
          <Form.Row className="Step-3">
            <Col md={5}>SK Jabatan (Hakim/Panitera) *</Col>
            <Col className="paddingLeft">Relasi SKP 1 Tahun Terakhir *</Col>
          </Form.Row>
