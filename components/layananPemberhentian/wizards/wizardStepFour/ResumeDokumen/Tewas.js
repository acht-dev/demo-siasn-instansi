        ...
        <div>
                  <Card>
                      ...
                      <Form.Row className="Step-3 ">
                          <Col md={5}>
                              <Form.Label>Dok SK Pemberhentian Atas Tewas*
                                </Form.Label>
                    ...
                    <Form.Row className="Step-3 align-items-center">
                        ...
                        <Col md={5}>
                            <Form.Label>
                            SK Penetapan Tewas dari Pejabat Pembina Kepegawaian (SKK)
                            </Form.Label>
                            <Form.Control disabled
                                id="custom-file"
                                value="Belum Upload Document"
                    ...
                    <Form.Row className="Step-3 align-items-center">
                        <Col md={5}>
                            <Form.Label>Surat Keterangan Duda dari Kelurahan/Kecamatan
                            </Form.Label>
                            <Form.Control disabled
                                id="custom-file"
                                value="Belum Upload Document"
                        ...
                        /></Col>
                        <Col md={5}>
                            <Form.Label>Surat Keputusan Peninjauan Masa Kerja</Form.Label>
                            <Form.Control disabled
                                id="custom-file"
                                value="Belum Upload Document"
                            />
