        ...
        <div>
                  <Card>
                      ...
                      <Form.Row className="Step-3 ">
                          <Col md={5}>
                              <Form.Label>Dok SK Pemberhentian Atas Hilang*
                                </Form.Label>
                    ...
                    <Form.Row className="Step-3 align-items-center">
                        ...
                        <Col md={5}>
                            <Form.Label>
                            Dok Surat Pernyataan Hilang dari Kepolisian
                            </Form.Label>
                            <Form.Control disabled
                                id="custom-file"
                                value="Belum Upload Document"
                    ...
                    <Form.Row className="Step-3 align-items-center">
                        ...
                        /></Col>
                        <Col md={5}>
                            <Form.Label>SK Pengangkatan Pertama Dalam Jabatan Fungsional</Form.Label>
                            <Form.Control disabled
                                id="custom-file"
                                value="Belum Upload Document"
                            />
