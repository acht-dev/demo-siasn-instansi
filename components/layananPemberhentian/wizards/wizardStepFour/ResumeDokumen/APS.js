        ...
        <div>
                  <Card>
                      ...
                      <Form.Row className="Step-3 ">
                          <Col md={5}>
                              <Form.Label>Dok SK Pemberhentian APS*
                                </Form.Label>
                      ...
                      <Form.Row className="Step-3 ">
                        ...
                        <Col md={5} >
                            <Form.Label>
                                Surat Usul Pemberhentian Atas Permintaan Sendiri sebagai PNS dari Instansi
                            </Form.Label>
                            <Form.Control disabled
                                id="custom-file"
                                value="Belum Upload Document"
                    ...
                    <Form.Row className="Step-3 align-items-center">
                        <Col md={5}>
                            <Form.Label> Surat Permohonan Berhenti Atas Permintaan Sendiri sebagai PNS
                            </Form.Label>
                            <Form.Control disabled
                                id="custom-file"
                                value="Belum Upload Document"
