        ...
        <div>
                  <Card>
                      ...
                      <Form.Row className="Step-3 ">
                          <Col md={5}>
                              <Form.Label>Dok SK Pemberhentian Tidak Cakap Jasmani/Rohani*
                                </Form.Label>
                      ...
                      <Form.Row className="Step-3 ">
                          <Col md={5}>
                              <Form.Label> 
                                Dok Surat Rekomendasi tidak cakap dari tim Penguji Kesehatan yang ditunjuk kementrian Kesehatan
                                </Form.Label>
                            <Form.Control disabled
                                id="custom-file"
                                value="Belum Upload Document"
                    ...
                    <Form.Row className="Step-3 align-items-center">
                        ...
                        /></Col>
                        <Col md={5}>
                            <Form.Label>Surat Keputusan Cacat dari Pejabat Pembina Kepegawaian
                             </Form.Label>
                            <Form.Control disabled
                                id="custom-file"
                                value="Belum Upload Document"
