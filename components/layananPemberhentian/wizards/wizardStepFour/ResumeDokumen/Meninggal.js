        ...
        <div>
                  <Card>
                      ...
                      <Form.Row className="Step-3 ">
                          <Col md={5}>
                              <Form.Label>Dok SK Pemberhentian Atas Meninggal Dunia (Janda/Duda)*
                                </Form.Label>
                    ...
                    <Form.Row className="Step-3 align-items-center">
                        ...
                        /></Col>
                        <Col md={5}>
                            <Form.Label>Surat Keterangan Duda dari Kelurahan/Kecamatan</Form.Label>
                            <Form.Control disabled
                                id="custom-file"
                                value="Belum Upload Document"
                            />
