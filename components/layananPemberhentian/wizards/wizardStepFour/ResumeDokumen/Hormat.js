        ...
        <div>
                  <Card>
                      ...
                      <Form.Row className="Step-3 ">
                          <Col md={5}>
                              <Form.Label>Dok SK Pemberhentian Dengan Hormat*
                                </Form.Label>
                    ...
                    <Form.Row className="Step-3 align-items-center">
                        <Col md={5}>
                            <Form.Label> Dok Surat Pernyataan Pengunduran Diri Bermaterai
                            </Form.Label>
                            <Form.Control disabled
                                id="custom-file"
                                value="Belum Upload Document"
                    ...
                    <Form.Row className="Step-3 align-items-center">
                        ...
                        /></Col>
                        <Col md={5}>
                            <Form.Label>Surat Keputusan Kenaikan Pangkat Terakhir</Form.Label>
                            <Form.Control disabled
                                id="custom-file"
                                value="Belum Upload Document"
                            />
                    ...
                    <Form.Row className="Step-3 align-items-center">
                        <Col md={5}>
                            <Form.Label>Surat Keputusan Pengangkatan, Pemindahan dan Pemberhentian Jabatan
                        ...
                        <Col md={5}>
                            <Form.Label>
                            SK Kenaikan Pangkat Penyesuaian Ijasah
                            </Form.Label>
                            <Form.Control disabled
                                id="custom-file"
                                value="Belum Upload Document"
                    ...
                    <Form.Row className="Step-3 align-items-center">
                        ...
                        <Col md={5}>
                            <Form.Label>
                            Surat Keputusan Bapek terkait Putusan Banding Administratif
