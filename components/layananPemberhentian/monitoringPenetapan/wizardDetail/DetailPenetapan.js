    ...
    <>
      <Layout>
        ...
        <div className='wizard__title'>
          <h2>Dokumen Penetapan Pemberhentian</h2>
        </div>
        {/* Card Profile */}
        <CardProfile />
        {/* End Card Profile */}
        ...
        <div className='wizard__inputForm'>
          <Form>
            ...
            <div className='wizard__inputForm-buttonBox mt-3'>
              ...
              <Link href='/layananPemberhentian/monitoringPenetapan/pembatalanMP'>
                <Button
              ...
              <Link href='/layananPemberhentian/monitoringPenetapan/perbaikanMP '>
                <Button
