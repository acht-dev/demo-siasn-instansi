...
export default function Prestasi(props) {
  const selectOptions = {
    jenisPrestasi: [" ", " "],
  };
  return (
    <>
      <div>
        ...
        <div className="card card-body my-3" id="Prestasi">
          <Row xs={12} sm={12}>
            <Col sm={6}>
              <Form.Group>
                <Form.Row>
                ...
                <Form.Row>
                  <Col sm={12} xs={5}>
                    ...
                    <Form.Control as="select" disabled>
                      {selectOptions.jenisPrestasi.map((data) => {
