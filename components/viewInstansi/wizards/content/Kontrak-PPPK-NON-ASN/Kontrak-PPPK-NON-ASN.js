...
export default function KontrakPPPKNONASN(props) {
  return (
    <>
      <div>
        <h3>Kontrak PPPK Non-ASN</h3>
        <div>
          <Tables
            keyField="id"
            data={products}
        ...
        <div className="card card-body my-3" id="Kontrak PPPK Non-ASN">
          <Row xs={12} sm={12}>
            <Col sm={6}>
              <Form.Group>
                <Form.Row>
