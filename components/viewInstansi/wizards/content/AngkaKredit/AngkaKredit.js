  ...
  return (
    <>
      <div>
        ...
        />
        <div className="card card-body my-3" id="Angka Kredit">
          <Row xs={12} sm={12}>
            <Col sm={6}>
              <Form.Group>
                <Form.Row>
                ...
                <Form.Row>
                  <Col sm={12} xs={5}>
                    ...
                    <Form.Control as="select" disabled>
                      {selectOptions.pilihBulanMulai.map((data) => {
              ...
              <Form.Group>
                <Form.Row>
                  <Col sm={12} xs={5}>
                    <Form.Label className="font-view-instansi">
                      Bulan Selesai Penilaian
                    </Form.Label>
                    <Form.Control as="select" disabled>
                      {selectOptions.pilihBulanSelesai.map((data) => {
                        return <option>{data}</option>;
                      })}
                    </Form.Control>
                  </Col>
              ...
              <Form.Group>
                ...
                <Form.Row>
                  ...
                  <input type="checkbox" defaultValue id="flexCheckDefault" />
                  <label
                    className="form-check-label font-view-instansi ml-2 mt-2"
