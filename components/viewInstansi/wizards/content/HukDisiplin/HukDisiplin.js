  ...
  return (
    <>
      <div>
        ...
        />
        <div className="card card-body my-3" id="Hukuman Disiplin">
          <Row xs={12} sm={12}>
            <Col sm={6}>
              <Form.Group>
                <Form.Row>
              ...
              <Form.Group>
                ...
                <Form.Row>
                  <Col>
                    <Form.Control
                      type="text"
                      placeholder="Pengaktifan Kembali"
                      className="font-view-instansi text-center"
                      disabled
                    />
                  </Col>
                </Form.Row>
