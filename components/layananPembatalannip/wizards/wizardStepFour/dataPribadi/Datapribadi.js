      ...
      <main className={styles.main}>
        <section className={styles.container}>
          ...
          <div className={styles.components}>
            ...
            <Form>
              <Form.Row>
                <Form.Group as={Col} md='5' controlId="nipbaru">
                  <Form.Label>Nip Baru</Form.Label>
                  <Form.Control disabled type="text" placeholder="3223232323222" />
                ...
                <Form.Group as={Col} md='5'controlId="email" className='ml-4'>
              ...
              <Form.Row>
                <Form.Group as={Col} md='5'controlId="niplama">
                ...
                <Form.Group as={Col} md='5'controlId="alamat" className='ml-4'>
                  <Form.Label>Alamat</Form.Label>
                  <Form.Control disabled type="text" placeholder="jakarta" />
                </Form.Group><FaTimesCircle
                        size="1rem"
                        color="red"
                        as={Col}
                        md="1"
              ...
              <Form.Row>
                <Form.Group as={Col} md='5' controlId="nama">
                  ...
                  <Form.Control disabled type="text" placeholder="Zulfa" />
                </Form.Group><FaCheckCircle
                        size="1rem"
                        color="green"
                        as={Col}
                        ...
                        style={{ marginTop: "2rem" }}
                      />
                <Form.Group as={Col} md='5' controlId="nomor" className='ml-4'>
              ...
              <Form.Row>
                ...
                <Form.Group as={Col} md='5' controlId="tempatLahir" className='ml-4'>
              ...
              <Form.Row>
                <Form.Group as={Col} md='5' controlId="jenisPegawai">
                  ...
                  >
                    <InputGroup>
                      ...
                      <InputGroup.Append>
                        ...
                        style={{ marginTop: "2rem" }}
                      />
                <Form.Group as={Col} md='5'controlId="pns"className='ml-4'>
                  ...
                  >
                    <Form.Control disabled as="select" class="mr-4 form-control">
              ...
              <Form.Row>
                <Form.Group as={Col} md='5' controlId="TanggalSK">
                  ...
                  <Form.Group as={Col} md='4'controlId="tanggal"className='ml-4'>
              ...
              <Form.Row>
                ...
                <Form.Group as={Col} md='5'controlId="tingkapendidikan" className='ml-4'>
              ...
              <Form.Row>
                <Form.Group as={Col} md='5' controlId="jenisKelamin">
                ...
                <Form.Group as={Col} md='5'controlId="kodependidikan" className='ml-4'>
              ...
              <Form.Row>
                  <Form.Group as={Col} md='5' controlId="pns">
                  ...
                  <Form.Group as={Col} md='5' controlId="pendidikan Terakhir" className='ml-4'>
                  ...
                  >
                    <Form.Control disabled type="text" class="mr-4 form-control"/>
                    <Form.Control disabled as="select">
